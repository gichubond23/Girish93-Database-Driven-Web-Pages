...
<html lang="en">
  ...
  <head>
    ...
    <!-- Bootstrap -->
    <link href="css/Part02_ArtistsDataListlatest.css" rel="stylesheet">
...
$querystring="SELECT a.FirstName,a.LastName,a.ArtistID,a.Details,a.YearOfBirth,a.YearOfDeath,a.Nationality,a.ArtistLink FROM artists a WHERE a.ArtistID=".$_GET['id'].";";
$querystring.="SELECT b.ImageFileName,b.Title,b.YearOfWork,b.ArtistID,b.ArtWorkID FROM artworks b WHERE b.ArtistID=".$_GET['id'].";";
...
?>
  ...
  <div class="col-sm-4">
  <?php if(empty($_GET['id'])||$_GET['id']!=$row['ArtistID'])
  {
  ...
  <tr>
  <td class="detail"><strong>More Info:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo '<a href="'.$row['ArtistLink'].'">'.$row['ArtistLink'].'</a>' ?></td>
  </tr>
  </tbody>
  </table>
  </div>
